...
var YoutubeDialog = {
    ...
    insert: function () {
        ...
        tinyMCEPopup.editor.execCommand('mceInsertContent', false, '<iframe class="youtube" src="http://www.youtube.com/embed/' + code + '" width="560" height="315"></iframe>');
        tinyMCEPopup.close();
    }
};
